...
%%% 1. Commands to make the title page %%%
%\usepackage{fullpage}
\makeatletter %@ as a letter, to use it in the following commands
...
\begin{document}
	...
	%%% 6. Tables of contents/Sommaires %%%
	...
	%% the following adds a frame around the résumé/abstract
	...
	\section*{Résumé}
	\lipsum[1-2]\\
	%write the résumé here (in french)
	...
	\section*{Abstract}
	\lipsum[1-2]\\
	%write the abstract here in english
